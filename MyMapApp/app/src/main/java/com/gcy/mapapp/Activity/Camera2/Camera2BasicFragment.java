...
package com.gcy.mapapp.Activity.Camera2;
...
//        String photoFilePath = SystemDirPath.getPhotoFilePath();
//        String stringDate = DateUtils.DateToString(new Date(), "yyyyMMddHHmmss");
//        mFile = new File(photoFilePath, stringDate+ ".jpg");
