...
//    String kURLGetTile = "http://t5.tianditu.com/DataServer?T=%s&tk=1a2360bdad0e682aba76bfb388fcb849";
//String kURLGetTile = "http://t0.tianditu.com/%s/wmts?service=wmts&request=gettile&version=1.0.0&layer=%s&format=tiles&tilematrixset=%s&tk=1a2360bdad0e682aba76bfb388fcb849";
    String kURLGetTile = "http://t2.tianditu.com/DataServer?T=%s&tk=4acb2987295122aa3f7fae79bf8d3992";
    ...
    public String getTianDiTuServiceURL() {
        String wmtsURL = String.format(kURLGetTile, servicename);
//        Log.d("tdtserviceurl",wmtsURL);
        return wmtsURL;
    }
}
